...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  // 🌸 Si solo envían .s sin imagen
  if (!m.quoted && !args[0]) {
    return conn.reply(
      m.chat,
      `🌸✨ *Senpai... por favor mándame una imagen JPG/PNG o un videíto de menos de 8s y respóndeme con* _${usedPrefix + command}_ *para convertirlo en sticker uwu 💖*`,
      m
    )
  }
