  ...
  try {
    ...
    for (let url of images) {
      ...
      cards.push({
        ...
        footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "© Powered by Danielrxz 🥷🏼👾" }),
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.fromObject({
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({ text: "© Powered by Danielrxz 🥷🏼" }),
