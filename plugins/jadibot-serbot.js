...
if (!isConnected) {
console.log(`${chalk.yellow(`[ ⚠️  ]  Socket ${path.basename(pathSanJadiBot)} sin conexión activa, limpiando...`)}`)
sock.ws.close();
sock.ev.removeAllListeners();
let i = globalThis.conns.indexOf(sock);
if (i < 0) return;
...
console.log(chalk.gray('Error al verificar conexión:', e.message))
}
}}, 120000)
