...
if (!text) return conn.reply(m.chat, '🌱 Por favor, ingresa un nombre de búsqueda o el enlace de TikTok.', m)
...
if (!data?.play) return conn.reply(m.chat, '⛔ Enlace es invalido o sin contenido descargable.', m)
...
await m.react('✖️')
await conn.reply(m.chat, `⚠︎ Se produjo un problema.\n\n${e.message}`, m)
}}
